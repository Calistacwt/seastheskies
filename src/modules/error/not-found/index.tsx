...
const NotFound = () => {
  ...
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center bg-[#1A2238]'>
      ...
      <div className='absolute rotate-12 select-none rounded bg-[#FF6A3D] px-2 text-sm'>Page Not Found</div>
      ...
      <button className='mt-5'>
        <div className='group relative inline-block text-sm font-medium text-[#FF6A3D] focus:outline-none focus:ring active:text-orange-500'>
          ...
          <div>
            <Link
              to='/'
              className='relative block border border-current bg-[#1A2238] px-8 py-3 tracking-widest'
            >
              Back
            </Link>
          </div>
